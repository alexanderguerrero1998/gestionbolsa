...
var _default = {
    ...
    getWrappedLookupDataSource: function(column, dataSource, filter) {
        ...
        var sliceItems = function(items, loadOptions) {
            var _loadOptions$skip;
            var start = null !== (_loadOptions$skip = loadOptions.skip) && void 0 !== _loadOptions$skip ? _loadOptions$skip : 0;
        ...
        var lookupDataSource = _extends({}, lookupDataSourceOptions, {
            ...
            load: function(loadOptions) {
                ...
                (function(loadOptions) {
                    ...
                    var newDataSource = new _data_source.DataSource(_extends({}, lookupDataSourceOptions, loadOptions, {
