...
var columnsViewMembers = {
    ...
    waitAsyncTemplates: function() {
        ...
        var needWaitAsyncTemplates = this.needWaitAsyncTemplates();
        var templateDeferreds = (forceWaiting || needWaitAsyncTemplates) && Array.from(this._templateDeferreds) || [];
    ...
    _updateContent: function($newTableElement) {
        ...
        return this.waitAsyncTemplates().done((function() {
            _this5.setTableElement($newTableElement);
            _this5._wrapTableInScrollContainer($newTableElement)
        }))
    },
