...
namespace Unach.DA.Empleo.Presentacion.CentralAdmin.Views.Shared.Components.MenuEscritorioUsuario
{
    public class MenuEscritorioUsuarioViewComponent: ViewComponent
    {
        EntitiesDomain entitiesDomain;
        private ILogger logger;

        public MenuEscritorioUsuarioViewComponent(DbContextOptions<SicoaContext> options, ILoggerFactory log)
        {
